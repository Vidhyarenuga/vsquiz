...
app.get('/', function (req, res) {
  var readQuiz = fs.readFileSync("data/Q&A.json", 'utf8');
...
app.post('/quiz', function(req, res){
  ...
  fs.writeFile("data/Q&A.json", jsonString);
